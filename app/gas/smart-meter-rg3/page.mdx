# User Operation Manual: Smart Meter RG3

![Smart Meter RG3](https://minio-api.apps.rokswood.com/rsaas-b/smart-meter-rg3.png-zGpnS)

## 1. About Your Smart Meter RG3

The **Smart Meter RG3** is an intelligent IoT meter designed to accurately measure your gas consumption. It offers real-time insights and convenient management of your utility services.
...
- **How to Trigger Wake-Up:**
  ...
  - Press and hold the softtouch trigger for 3 seconds; when successfully triggered, the display will show the message `S - Send`.

- **Confirmation:** Once triggered, the meter will connect to the server, update its status, and display the new credit balance. This process usually takes a few seconds.
