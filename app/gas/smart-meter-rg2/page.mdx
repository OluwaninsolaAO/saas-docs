# User Operation Manual: Smart Meter RG2

![Smart Meter RG2](https://minio-api.apps.rokswood.com/rsaas-b/smart-meter-rg2.png-NrSuY)

## 1. About Your Smart Meter RG2

The **Smart Meter RG2** is an intelligent IoT meter designed to accurately measure your gas consumption. It offers real-time insights and convenient management of your utility services.
...
- **Indicator Lights:** Occationally, the meter indicator light flashes red, this happens during the meter's wake cycle.

### 3.2 Understanding Your Readings

Your meter provides real-time data on your consumption.

- **KG:** Your meter measures gas in KG.
...
- **How to Trigger Wake-Up:**
  ...
  - Press and hold the red trigger button until when the red indicator light comes up, wait for 15 seconds and press and hold the trigger again for 5 seconds.
...
- **What happens if my credit runs out?**
  - Your gas supply will be disconnected until you recharge your meter.
